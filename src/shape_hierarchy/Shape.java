...
Each Two-DimensionalShape should contain method getArea to calculate the area of the two-dimensional shape.
...
If it’s a TwoDimensionalShape, display its area. If it’s a ThreeDimension- alShape, display its area and volume.
 */
